...
///UISource File Create Data: 7/11/2015 4:30:28 PM
public partial class ContainerOperationjixiansaiUIController : UIControllerBase {
	...
	public GameObject LabelXingshimubiaojuli;
	public Vector3 UIOriginalPositionLabelXingshimubiaojuli;
	...
	public GameObject LabelXingshijuliJuqing;
	public Vector3 UIOriginalPositionLabelXingshijuliJuqing;
	...
	void Awake() {
		...
		LabelXingshimubiaojuli=this.transform.FindChild ("LabelXingshimubiaojuli").gameObject;
		UIOriginalPositionLabelXingshimubiaojuli=this.LabelXingshimubiaojuli.transform.localPosition;
		...
		LabelXingshijuliJuqing=this.transform.FindChild ("LabelXingshijuliJuqing").gameObject;
		UIOriginalPositionLabelXingshijuliJuqing=this.LabelXingshijuliJuqing.transform.localPosition;
