...
public class TweenUtils
{
	...
	public static float getEasingValue(Easetype easetype,float start,float end,float pro)
	{
		EasingFunction f=GetEasingFunction (easetype);
		return f (start,end,pro);
	}
...
*/
	...
	public static void CameraFadeTo (float value, float duration)
	{
		validateCameraFade ();
		iTween.CameraFadeTo (value, duration);
	}
	/// <summary>
	/// Validates the camera fade.
	/// </summary>
	public static void validateCameraFade ()
	{
		GameObject obj = (GameObject)GameObject.Find ("iTween Camera Fade");
		if (obj == null)
		{
